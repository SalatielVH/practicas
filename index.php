...
<body>
	...
	if (isset($_POST['enviar'])){
		...
		if($usuario == "admin" && $pass == "admin"){
			echo "<font color='blue' face='arial' size=3>
    ...
    <div align=center width=100%>
		...
		else if ($usuario == "supervisor" && $pass == "visor"){
			echo " <font color='Blue' face='arial' size=3>
        <h1 align='center'><i>Principal</i></h1>
         </font>
         <div align=center width=100%>
         ...
         <table style='width:30%' border='1'>
              ...
              <tr> <td rowspan='1'> Administrador </td><td> Admin</td> </tr>
              <tr> <td rowspan='1'> Supervisor </td><td> Superivisor</td></tr>
              <tr> <td rowspan='1'> Usuario </td><td>Usuario</td></tr>
               </thead>
          </table>
          </font>
          </div>"; 
		...
		echo "el usuario es $usuario, la contraseña es $pass";	
	} else {
?>
